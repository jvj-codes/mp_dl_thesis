...
from rl_project.WealthAllocationBehavior import WealthChannelsModel
import numpy as np
import sympy
...
# DeepSimulate
K_time = 1.0
model_DL['DeepSimulate'] = WealthChannelsModel.WealthBehaviorModelClass(algoname='DeepSimulate', device=device,train={'K_time': K_time})
model_DL['DeepSimulate'].solve(do_print=True)

# DeepVPD
K_time = 3.0
model_DL['DeepVPD'] = WealthChannelsModel.WealthBehaviorModelClass(algoname='DeepVPD', device=device,train={'K_time': K_time})
